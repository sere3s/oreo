...
plotStressStrain <- function(stress, strain,strain_in,stress_in,type="l",...){
  plot(strain, stress , main="stress-strain", xlab="Strain [-]", ylab ="Stress [Pa]", col="red",lwd=2,...)
...
#' stress= out$spp_data_out$stress
#' rate_in= out$spp_data_in$strain_rate
#' stress_in= out$spp_data_in$stress
...
plotStressRate <- function(stress, rate,type="l",...){
  plot(stress,rate,main="stress-rate",xlab ="Rate [1/s]", ylab="Stress [Pa]",, col="red",lwd=2,...)
  lines(strain_in,stress_in, col="blue")
  legend("topleft",legend=c("raw stress", "reconstructed"),col=c("red", "blue"), lty=1:2, cex=0.6)
  abline(h=0, v=0,lty=2)
}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25 
plotColeCole <- function(Gp_t,Gpp_t,type="l",...){
  plot(Gp_t,Gpp_t,main="Cole-Cole plot",xlab=expression("G'"[t]*" [Pa]"),ylab=expression("G''"[t]*" [Pa]"), col="red",lwd=2,...)
  abline(h=0,v=0, lty=2)
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25 
plotGpdot <- function(Gp_t_dot,Gpp_t_dot,type="l",...){
  plot(Gp_t_dot,Gpp_t_dot,main=expression("dG'"[t]*"/dt-dG''"[t]*"/dt"), xlab=expression("dG'"[t]*"/dt [Pa/s]"),ylab=expression("dG''"[t]*"/dt [Pa/s]"), col="red",lwd=2,... ) 
}
...
plotSpeedGp <- function(Gp_t,G_speed,type="l",...){
  plot(Gp_t,G_speed,main=expression("Speed-G'"[t]*"") ,xlab=expression("G'"[t]*" [Pa]"),ylab=expression("Speed-G''"[t]*" [Pa/s]"), col="red",lwd=2,... )}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotSpeedGpp <- function(G_speed,Gpp_t,type="l",...){
  plot(G_speed,Gpp_t,main=expression("Speed-G''"[t]*"") ,xlab=expression("Speed [Pa/s]"),ylab=expression("G''"[t]*" [Pa]"), col="red",lwd=2 )
}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotDeltaStrain <- function(strain,delta_t,type="l",...){
  plot(strain,delta_t,main=expression("delta"[t]*"-strain"),xlab=expression("strain [-]"),ylab=expression("delta"[t]*" [rad]"), col="red",lwd=2,... )}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotPAV  <- function(strain,delta_t_dot,type="l",...){
  plot(strain,delta_t_dot,main="PAV-strain",xlab=expression("strain [-]"),ylab=expression("PAV [] (time-normalized)"), col="red", lwd=2,...)}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotDisp  <- function(strain,disp_stress,type="l",...){
  plot(strain,disp_stress,main="displacement stress-strain",xlab=expression("strain [-]"),ylab=expression("displacement stress [Pa]"), col="red", lwd=2,... )}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotStrain <- function(Gp_t,eq_strain_est,type="l",...){
  plot(Gp_t,eq_strain_est,main="est. eq. strain-tan(delta)",xlab=expression("G'"[t]*" [Pa]"),ylab=expression("esp eq. strain[-]"), col="red", lwd=2,... )}
...
#' @references Simon A. Rogersa, M. Paul Letting, A sequence of physical processes determined and quantified in large-amplitude oscillatory shear (LAOS): Application to theoretical nonlinear models
#' Journal of Rheology 56:1, 1-25
plotTimeStrain <- function(time_wave,strain,time_wave_in,strain_in,type="l", ...){
  plot(time_wave,strain,main="Strain-time",xlab=expression("Time [s]"),ylab = expression("Strain [-]"), col="red",xlim=c(0,3), lwd=2,...)
...
plotTimeRate <- function(time_wave,rate,time_wave_in,strain_rate,type="l",...){
  plot(time_wave,rate,main="Rate-time",xlab=expression("Time [s]"),ylab = expression("Rate [1/s]"), col="red",xlim=c(0,3), lwd=2,...)
...
plotTimeStress <- function(time_wave,stress,time_wave_in,strain_rate,type="l",...){
  plot(time_wave,stress,main="Stress-time",xlab=expression("Time [s]"),ylab=expression("Stress [Pa]"), col="red", xlim=c(0,3), lwd=2,...)
  lines(time_wave_in,strain_rate,lty=2)}
...
plotStressTime <- function(time_wave_in,stress_in,time_wave,stress,type="l",){
  plot(time_wave_in,stress_in,xlab=expression("Time[s]"),ylab=expression("Stress [Pa]"), col="black",lty=2,... )
...
#' 
#' @export
plotFft <- function(ft_amp,fft_resp,spp_params,type="l",...){
